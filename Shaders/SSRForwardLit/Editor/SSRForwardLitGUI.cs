...
namespace UnityEditor.Rendering.Universal.ShaderGUI
{
    ...
    /// </summary>
    internal static class SSRForwardLitGUI
    {
        /// <summary>
        ...
        public static class Styles
        {
            ...
            /// Custom stylized GUI
            /// </summary>
            public static GUIContent useSSSText = EditorGUIUtility.TrTextContent("SSS", "");
            public static GUIContent sssPowerText = EditorGUIUtility.TrTextContent("SSS Power", "");
            public static GUIContent sssScaleText = EditorGUIUtility.TrTextContent("SSS Scale", "");
            public static GUIContent sssNormalDistortionText = EditorGUIUtility.TrTextContent("SSS Normal Distortion", "");
        ...
        public struct LitProperties
        {
            ...
            public MaterialProperty sssPower;
            public MaterialProperty sssScale;
            public MaterialProperty sssNormalDistortion;
            ...
            public LitProperties(MaterialProperty[] properties)
            {
                ...
                // Surface Input Props
                useSSS = BaseShaderGUI.FindProperty("_USE_SSS", properties);
                sssPower = BaseShaderGUI.FindProperty("_SSS_Power", properties);
                sssScale = BaseShaderGUI.FindProperty("_SSS_Scale", properties);
                sssNormalDistortion = BaseShaderGUI.FindProperty("_SSS_NormalDistortion", properties);
        ...
        public static void Inputs(LitProperties properties, MaterialEditor materialEditor, Material material)
        {
            ...
            if (material.HasProperty("_USE_SSS"))
        ...
        {
            materialEditor.ShaderProperty(properties.useSSS, Styles.useSSSText);
            var sssEnabled = material.GetFloat("_USE_SSS") > 0.0;

            EditorGUI.BeginDisabledGroup(!sssEnabled);
            {
                EditorGUI.indentLevel += 2;

                materialEditor.ShaderProperty(properties.sssPower, Styles.sssPowerText);
                materialEditor.ShaderProperty(properties.sssScale, Styles.sssScaleText);
                materialEditor.ShaderProperty(properties.sssNormalDistortion, Styles.sssNormalDistortionText);
    ...
    internal class SSRForwardLitDetailGUI
    {
