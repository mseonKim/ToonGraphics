...
namespace UnityEditor.Rendering.Universal.ShaderGUI
{
    internal class StylizedLitShader : BaseShaderGUI
    {
        ...
        private StylizedLitDetailGUI.LitProperties litDetailProperties;

        public override void FillAdditionalFoldouts(MaterialHeaderScopeList materialScopesList)
        {
            materialScopesList.RegisterHeaderScope(StylizedLitDetailGUI.Styles.detailInputs, Expandable.Details, _ => StylizedLitDetailGUI.DoDetailArea(litDetailProperties, materialEditor));
        }
        ...
        public override void FindProperties(MaterialProperty[] properties)
        {
            ...
            litDetailProperties = new StylizedLitDetailGUI.LitProperties(properties);
        }

        // material changed check
        public override void ValidateMaterial(Material material)
        {
            SetMaterialKeywords(material, StylizedLitGUI.SetMaterialKeywords, StylizedLitDetailGUI.SetMaterialKeywords);
        }
